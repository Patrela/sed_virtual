...
//emulate \Laravel\Sanctum\Http\Middleware\EnsureFrontendRequestsAreStateful - Need to avoid save memory and User session
class HandleCorsSanctum
{
    /**
    ...
    public function handle($request, $next)
    {
        ...
        $output= (new Pipeline(app()))->send($request)->through(
