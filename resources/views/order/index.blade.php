...
@section('content')
    ...
    <div class="container" id="orderContainer">
        ...
        <div class="modal-card-item-division">
            ...
            <div class="list-text-title">Trade Nit
            </div>
            <div class="list-text-title">Buyer Name
            </div>
            <div class="list-text-title">Trade Request
            </div>
        ...
        <div class="modal-card-item-division">
                    <div class="list-text-large">{{ $order['order'] }}
                    </div>
                    <div class="list-text">{{ $order['trade_nit'] }}
                    </div>
                    <div class="list-text">{{ $order['buyer_name'] }}
                    </div>
                    <div class="list-text">{{ $order['trade_request_code'] }}
                    </div>
