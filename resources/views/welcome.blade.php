        ...
        <div
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <header class="mainmenu grid grid-cols-3 items-center gap-2 py-10 lg:grid-cols-3">
                    ...
                    @endif
                    <nav class="mx-3 flex flex-1 justify-end">
                        <x-text-input id="search" class="mx-3 block mt-1 w-full lg:justify-left" type="text"
                                name="search" :value="old('search')" required autofocus autocomplete="search" />
                                <a class="mx-3 search" href="{{ route('dashboard') }}"><i
                                    class="mx-3 fas fa-search"></i></a>
                                    <a class="-mx-3 home" href="{{ route('home') }}"><i class="-mx-3 fas fa-home"></i></a>
                    </nav>
                </header>
